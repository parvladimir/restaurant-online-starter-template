...
На мобильной версии при `showThemeSwitcher: true` выбор темы тоже доступен, но компактно: над нижними кнопками заказа появляется маленькая кнопка `Design`. По нажатию она раскрывает выбор темы и ссылку на все дизайны. Так клиент может протестировать темы на телефоне, но сайт не выглядит как техническая демо-страница.
